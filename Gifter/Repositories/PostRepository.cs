...
namespace Gifter.Repositories
{
    public class PostRepository : BaseRepository, IPostRepository
    {
        ...
        //New Method to tie userprofiles to the post repository... replacing the above and ultimatley saving space and db constraints
        public List<Post> GetAll()
        {
            using (var conn = Connection)
            {
        ...
        public List<Post> Search(string criterion, bool sortDescending)
        {
            using (var conn = Connection)
            {
                ...
                using (var cmd = conn.CreateCommand())
                {
                    ...
                    FROM Post p 
                        LEFT JOIN UserProfile up ON p.UserProfileId = up.id
                    WHERE p.Title LIKE @Criterion OR p.Caption LIKE @Criterion OR p.DateCreated LIKE @Criterion ";
        ...
        public List<Post> Search2(DateTime criterion, bool sortDescending)
        {
            using (var conn = Connection)
            {
                conn.Open();
                using (var cmd = conn.CreateCommand())
                {
                    ...
                    FROM Post p 
                        LEFT JOIN UserProfile up ON p.UserProfileId = up.id
                    WHERE p.DateCreated LIKE @Criterion ";
